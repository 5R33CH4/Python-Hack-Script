...
g_aimbot_rcs = True
g_aimbot_head = True
g_aimbot_fov = 120.0 / 180.0
g_aimbot_smooth = 3.0
g_aimbot_key = 104      # h to toggle
g_triggerbot_key = 113  # q to toggle
g_exit_key = 47         # / to exit
...
if __name__ == "__main__":
    ...
    print('[*]Info')
    print('    Creator:            github.com/5r33ch4')
    print('     h           -      to toggle Aimbot')
    print('     q           -      to toggle TriggerBot')
    print('     /           -      to EXIT Cheat,)
    previous_tick = 0
